...
{
$adminid=$_GET['id'];
$msg=mysqli_query($con,"delete from tblleavetype where id='$adminid'");
if($msg)
{
                ...
                <table id="example1" class="table table-bordered table-striped">
                             ...
                             <thead>
                                  ...
                                  <th>Action</th>
                                    ...
                                    <tbody>
                                              <?php $ret=mysqli_query($con,"select * from tblleavetype");
                              $cnt=1;
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td>
                                     ...
                                     <a href="admin-leave.php?uid=<?php echo $row['id'];?>"> 

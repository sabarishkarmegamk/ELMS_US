  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="change-password.php" class="nav-link">Change Password here</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="logout.php" class="nav-link">SIGNOUT here</a>
      </li>
      <!--li class="nav-item d-none d-sm-inline-block">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="manageleavetype.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<u1>
              ...
              <li class="nav-item">
                <a href="notapprove.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Not Approve</p>
                </a>
              </li-->

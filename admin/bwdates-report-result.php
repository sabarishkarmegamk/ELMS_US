...
<?php include_once('includes/sidebar.php');?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="manage-users.php">BW Dates users</a></li>
  ...
  <div class="card">
              <div class="card-header">
                <h3 class="card-title">B/w Dates Report Result</h3>
              </div>
...
?>
                           ...
                           <!-- /.card-header -->
              <div class="card-body">
                 <?php echo date("d-m-Y", strtotime($fdate));?> to <?php echo date("d-m-Y", strtotime($tdate));?>
